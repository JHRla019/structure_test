    ...
    implements List<E>, Deque<E>, Cloneable, java.io.Serializable
{
    ...
    public PeekList(Collection<? extends E> c) {
	this();
	addAll(c);
    }
...
//    }
    ...
    public E SequentialGet(int index) {
    	...
    	PeekList<E> tempList = (PeekList<E>) this.clone();
...
//    
	...
	public void remove() {
            ...
            try {
                PeekList.this.remove(lastReturned);
    ...
    public Object clone() {
        PeekList<E> clone = null;
	try {
	    clone = (PeekList<E>) super.clone();
