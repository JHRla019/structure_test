...
public class StdList<E> extends AbstractSequentialList<E> implements List<E>,
	...
	public StdList(int std) {
		header.next = header.previous = header;
		this.std = std;
	}

	public StdList(Collection<? extends E> c) {
		this();
		addAll(c);
	}
	...
	private class ListItr implements ListIterator<E> {
		...
		public void remove() {
			...
			try {
				StdList.this.remove(lastReturned);
	...
	public Object clone() {
		StdList<E> clone = null;
		try {
			clone = (StdList<E>) super.clone();
