...
public class SinglyLinkedList<E> extends AbstractSequentialList<E> implements
	...
	public void printR(List<E> list, int size) {
		for (int i = 0; i < size; i++) {
			...
			if (list instanceof DoublyCircularLinkedList
	...
	private class ListItr implements ListIterator<E> {
		...
		public void remove() {
			...
			try {
				SinglyLinkedList.this.remove(lastReturned);
	 ...
	 */
	public Object clone() {
		SinglyLinkedList<E> clone = null;
		try {
			clone = (SinglyLinkedList<E>) super.clone();
